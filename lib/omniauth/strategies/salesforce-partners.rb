...
module OmniAuth
  module Strategies
    class Salesforce::Partners < OmniAuth::Strategies::OAuth2
    ...
    class SalesforceSandbox < OmniAuth::Strategies::Salesforce::Partners
      default_options[:client_options][:site] = 'https://test.salesforce.com'
    end

    class DatabaseDotCom < OmniAuth::Strategies::Salesforce::Partners
      default_options[:client_options][:site] = 'https://login.database.com'
    end

    class SalesforcePreRelease < OmniAuth::Strategies::Salesforce::Partners
